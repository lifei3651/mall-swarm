...
RELEASE_DIR=/tmp/lingqimall-release-v1.0.19-backend
ROLLBACK_DIR=/tmp/lingqimall-rollback-v1.0.19-backend
BACKUP_PATH=""
MUTATED=0
...
[[ "$(tr -d '[:space:]' < "$RELEASE_DIR/VERSION")" == "1.0.19" ]]
...
echo "release-success version=1.0.19 backup=$BACKUP_PATH"
