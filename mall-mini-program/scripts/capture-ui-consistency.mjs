...
cases.push(['support-create','pages/support/index?create=1'],['support-empty','pages/support/index?create=1',{empty:true}],['support-error','pages/support/index?create=1',{failure:'/shop/orders'}],['address-edit','pages/address/index',{},'startAdd'],['payment-password','pages/account-settings/index?section=payment'],['real-name','pages/account-settings/index?section=identity'],['change-password','pages/account-security/index?mode=password'],['change-phone','pages/account-settings/index?section=phone'],['checkout-remark','pages/checkout/index',{},'openRemark'],['withdraw-blocked','pages/withdraw/index',{firstPassword:true}],['order-return','pages/order-detail/index?id=13201',{saleStatus:4}],['product-services','pages/product/index?id=1',{},'openServices'])
