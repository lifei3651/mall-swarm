// Generated from mall-shop-web/src/utils/orderListRules.js. Do not edit.
// Extracted unchanged from OrdersView: H5 remains the rule source for both clients.
const isTradeActionOwner = (item, rows) => !item.order?.tradeId
...
const canApplyAfterSale = (item, now = Date.now()) => ![0, 4].includes(item.order?.status)
...
module.exports = { isTradeActionOwner, afterSaleDeadline, unavailableAfterSaleQuantity, orderQuantity, canApplyAfterSale }
