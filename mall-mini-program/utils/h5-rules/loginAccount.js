// Generated from mall-shop-web/src/utils/loginAccount.js. Do not edit.
const LOGIN_ACCOUNT_PATTERN = /^[A-Za-z][A-Za-z0-9_]{3,19}$/

const normalizeLoginAccountInput = (value) => String(value ?? '')
...
const resolveRegistrationErrorField = (message) => {
...
module.exports = { LOGIN_ACCOUNT_PATTERN, normalizeLoginAccountInput, validateLoginAccount, resolveRegistrationErrorField }
