// Generated from mall-shop-web/src/utils/pageLayouts.js. Do not edit.
...
const LAYOUT_PLATFORMS = ['h5', 'mini', 'app']
...
const normalizePageLayouts = (config = {}) => {
...
const resolvePageLayouts = (config = {}, platform = 'h5') => {
...
const hasEmptyDirectoryLayout = (config = {}) => {
  const ext = extra(config)
...
module.exports = { PAGE_LAYOUT_OPTIONS, LAYOUT_PLATFORMS, normalizePageLayouts, resolvePageLayouts, hasEmptyDirectoryLayout }
