...
module.exports = { titles, resolveText, content, faqs, miniPrivacy: miniPrivacy + miniClientNotice.replace('换绑手机号、注销账号及其他尚无自助入口的请求需联系客服', '换绑手机号可在账号资料内自助办理；旧手机号已停用、注销账号及其他尚无自助入口的请求需联系客服') + miniInviteNotice + accountNotice + liveNotice, contactValue }
