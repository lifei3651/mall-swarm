...
| MC04 | P0 / 邀请注册 | 手填可选、扫码来源明确、邀请人脱敏核对、首次一次绑定 | 无码可注册；无效/非有效会员邀请被后端拒；老账号不改绑 | 1.0.131代码/自动通过：补手填、核对、冲突选择、24小时过期提示/登录清理、来源记录；原生/真机及部署待验；原03、21 |
...
- 发布依赖：先部署新增后端能力接口，再上传原生包。当前后端126无新接口，新版邀请将关闭并提示重试，不能据此宣布生产功能已开。没有发布、实际分享消息、代同意、注册或资金变更。范围和逐项验收见[131验收记录](qa/2026-09-06-mini-invite-capabilities-131.md)。
