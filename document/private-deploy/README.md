...
`html/public`、`html/team`、`html/integrated`、`html/admin`。默认部署继续使用拆分的公开商城与团队 H5；客户确认采用一体化模式时，将一体化目录配置为该客户 H5 域名的静态根目录。发现测试失败、公开包含团队业务文字或接口、一体化功能分块缺失、source map 或版本不一致会停止。
