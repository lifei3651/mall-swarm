...
本地版本：`1.0.101`（客户交付工具与微信小程序通用基座，待发布）
...
```mermaid
flowchart TB
    U1[普通消费者] --> P[公开商城 H5 / Android / 微信小程序]
    U2[团队会员] --> T[团队 H5]
    U3[客户运营人员] --> A[管理后台]
    U4[入驻商户] --> M[受限商户工作台]
...
- 微信小程序是独立原生前端项目，不是 H5 套壳；本地候选已具备浏览、购物车、微信登录、首次手机号注册和订单读取基础能力，但每个客户仍需自己的微信主体、AppID、合法域名、隐私审核与真机验收。
...
| 微信小程序 | 独立原生前端、微信登录与手机号注册基座已完成 | 本地`1.0.101`候选；无客户AppID、支付和审核，不在线上 | 🔵 基座已开发待发布，客户交付属🟠外部条件 |
...
| 微信小程序公开商城 | 浏览、分类、商品、购物车、微信登录、首次手机号注册、个人中心和订单列表已完成 | 客户支付未接入，结算安全停止；尚未提交微信审核 | 🔵 通用基座待发布，正式上线属🟠客户条件 |
...
| 微信小程序 | 原生公开商城与安全登录基座已完成；支付、订阅消息保持关闭 | 🔵 `1.0.101`待发布；每客户独立AppID、支付、审核和真机UAT |
| 其他新渠道 | Android已有构建链；iOS尚无正式客户端 | 🟣/⚪ 按客户独立立项 |
...
本文件描述的是 2026-08-30、线上`1.0.100`与本地`1.0.101`候选的产品实施状态；客户交付工具和微信小程序通用基座尚未发布。后续每次正式开放新功能或新增渠道，应同步更新状态矩阵和路线图，而不是只在发版日志中记录技术改动。
