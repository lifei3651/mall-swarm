# 小程序能力盘点与原27项技术清单（历史基线）

> 2026-09-06补充：当前产品设计、优先级与逐批执行统一转入[小程序产品总控规划](MINI_PROGRAM_PRODUCT_MASTER_PLAN.md)。本文件保留当时的检查证据，不继续以“H5有就全部复制”作为开发标准；原22项UI优先级由总控表按任务影响重新划分。下文版本和测试数字均为当时结果。
