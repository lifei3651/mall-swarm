...
SET login_account = 'SYSTEM_REMAINDER', nickname = '系统剩余金额账户',
    status = 0, system_account = 1, team_opt_in = 0
...
INSERT INTO dms_member_asset_account
    (agent_id, user_id, asset_code, asset_name, balance, frozen_balance,
     withdrawable_balance, total_in, total_out)
SELECT id, user_id, 'CASH_BONUS', '余额', 0, 0, 0, 0, 0
FROM dms_agent a
WHERE a.user_id IN (-900000000000000001, -900000000000000005)
  AND NOT EXISTS (
