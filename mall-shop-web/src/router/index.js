...
const routes = [
  ...
  { path: '/messages/:id', name: 'MessageDetail', component: () => import('@/views/MessageDetailView.vue'), meta: { requiresAuth: true } },
  { path: '/support', name: 'ServiceTickets', component: () => import('@/views/ServiceTicketsView.vue'), meta: { requiresAuth: true } },
  { path: '/support/:id', name: 'ServiceTicketDetail', component: () => import('@/views/ServiceTicketDetailView.vue'), meta: { requiresAuth: true } },
  ...
  { path: '/profile/wallet', name: 'ProfileWallet', component: () => import('@/surfaces/public/PublicWalletView.vue'), meta: { requiresAuth: true } },
  { path: '/profile/real-name', name: 'RealNameVerification', component: () => import('@/views/RealNameVerificationView.vue'), meta: { requiresAuth: true } },
  ...
  { path: '/profile/coupons', name: 'Coupons', component: () => import('@/views/CouponsView.vue'), meta: { requiresAuth: true } },
