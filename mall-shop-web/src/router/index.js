...
const routes = [
  ...
  { path: '/login', name: 'Login', component: () => import('@/surfaces/public/PublicLoginView.vue') },
  { path: '/register', name: 'Register', component: () => import('@/surfaces/public/PublicLoginView.vue') },
