...
@media(max-width:720px){.team-shell{height:100vh;height:100dvh;min-height:0;display:grid;grid-template-rows:auto minmax(0,1fr) auto;overflow:hidden;padding-bottom:0}.team-header{min-height:58px;padding:0 15px}.team-brand strong{font-size:14px}.team-header nav{display:none}.team-shell main{min-height:0;overflow-x:hidden;overflow-y:auto;overscroll-behavior-y:contain;-webkit-overflow-scrolling:touch}.team-bottom-nav{position:relative;z-index:30;display:grid;grid-template-columns:repeat(4,1fr);padding:7px 0 calc(7px + env(safe-area-inset-bottom));background:#fff;border-top:1px solid #e8ebf0}.team-bottom-nav a{display:flex;flex-direction:column;align-items:center;gap:3px;color:#7b8493;font-size:11px}.team-bottom-nav a.router-link-exact-active{color:var(--brand-primary,#e7193f)}}
</style>
