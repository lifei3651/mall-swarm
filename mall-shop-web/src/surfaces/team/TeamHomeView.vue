...
@media(max-width:720px){.team-home{width:calc(100% - 20px);padding:15px 0}.team-hero{padding:22px;border-radius:19px}.metric-grid{grid-template-columns:1fr}.action-grid{grid-template-columns:1fr 1fr}.action-grid a{padding:17px}.team-hero h1{font-size:23px}}
</style>
