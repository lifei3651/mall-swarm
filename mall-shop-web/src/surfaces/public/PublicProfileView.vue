...
.service-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:12px}.service-grid>a{display:flex;flex-direction:column;gap:8px;padding:19px;color:var(--brand-primary,#e7193f);background:#fff;border-radius:16px}.service-grid strong{color:#253044;font-size:14px}.service-grid span{color:#98a2b3;font-size:12px}.profile-error{padding:12px 14px;color:#b42318;background:#fff1f0;border-radius:10px}.logout-button{justify-self:center;margin:12px 0 24px;padding:11px 24px;color:#fff;background:#c92d45;border:1px solid #b72339;border-radius:12px;font-weight:700}
