      ...
      <div v-if="step === 2">
        <div class="form-grid">
          <div class="form-item full">
            ...
            <input id="forgot-new-password" v-model="newPassword" name="newPassword" class="field" type="password" minlength="6" maxlength="32" autocomplete="new-password" placeholder="6至32位" />
          </div>
          <div class="form-item full">
...
const doResetPassword = async () => {
  ...
  clearError()
  if (!newPassword.value || newPassword.value.length < 6 || newPassword.value.length > 32) { showError('新密码需要6至32位'); return }
