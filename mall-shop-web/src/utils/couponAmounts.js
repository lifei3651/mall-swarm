...
export function couponRefundPreview(items = [], selected = [], sales = []) {
  let total = 0
...
export function couponQuoteValid(quote, claimId) {
...
export function canReviseRejectedOrder(error, previousAttempt) {
