  ...
  <div class="page-container">
    ...
    <el-dialog v-model="passwordVisible" title="重置会员登录密码" width="540px" destroy-on-close>
      ...
      <el-form :model="passwordForm" label-width="115px" class="level-form">
        ...
        <el-form-item label="新登录密码" required><el-input v-model="passwordForm.newPassword" type="password" show-password minlength="6" maxlength="32" autocomplete="new-password" placeholder="6至32位" /></el-form-item>
    ...
    <el-dialog v-model="createVisible" title="后台新增商城会员" width="620px" destroy-on-close>
      ...
      <el-form :model="createForm" label-width="120px" class="create-form">
        ...
        <el-form-item label="初始登录密码">
          <el-input v-model="createForm.password" type="password" show-password minlength="6" maxlength="32" autocomplete="new-password" placeholder="选填，6至32位" />
