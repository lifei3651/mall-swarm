const fields = {
  ...
  repurchaseMallEnabled: '复购商城', repurchaseEligibilityMode: '复购进入资格', repurchaseBonusMode: '复购奖金处理',
}
const labels = { DISABLED: '关闭', AUTO_ON_INVITE: '受邀即开通', MANUAL_REVIEW: '后台审核', FIRST_PAID_ORDER: '首笔有效订单', NONE: '不计奖', STANDARD: '历史兼容状态', CUSTOM: '客户奖金程序（未接入禁下单）', PAID_MEMBER: '已开通推广资格', AGENT: '代理及以上', ALL_MEMBER: '全部注册会员' }
