...
CREATE TABLE IF NOT EXISTS dms_shop_product_review (
  ...
  merchant_reply_version INT NOT NULL DEFAULT 0,
  merchant_reply_by BIGINT,
  merchant_reply_time TIMESTAMP,
  platform_reply VARCHAR(500),
  platform_reply_version INT NOT NULL DEFAULT 0,
  platform_reply_by BIGINT,
  platform_reply_time TIMESTAMP,
  status INT NOT NULL DEFAULT 1,
